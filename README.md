...
* 📁 [Project Understanding](./docs/project_understanding/) — Milestone-by-milestone technical deep dives and 10-Q&A defense sheets (e.g. [01: Master Architecture](./docs/project_understanding/01_master_architecture_and_roadmap.md), [02: Phase 0 Infrastructure](./docs/project_understanding/02_phase0_infrastructure_and_foundations.md), [03: Phase 1 AST RAG](./docs/project_understanding/03_phase1_ast_rag_layer.md)).
